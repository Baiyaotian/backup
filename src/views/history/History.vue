  ...
  <div class="history" height="100%">
    <div class="container-content">
      ...
      >
        ...
        <el-table-column prop="backupName" align="center" min-width="120px" sortable="custom" label="备份名称"></el-table-column>
        <el-table-column prop="recovertype" align="center" min-width="80px" label="类型"></el-table-column>
        <el-table-column prop="ip" align="center" min-width="150px" sortable="custom" label="备份客户端IP"></el-table-column>
        ...
        <el-table-column type="expand" width="0">
          <template slot-scope="scope">
            ...
            <el-row>
              <el-col :span="12" v-for="(item, key, index) in scope.row.backupData" :key="index"> {{key}}: {{item}}</el-col>
            </el-row>
    ...
    tableRowClick (row) {
      this.tableData.forEach(item => {
        if (typeof item.backupData === 'string') {
          ...
          item.backupData.exclude = item.backupData.exclude.join(', ')
          item.backupData.include = item.backupData.include.join(', ')
        }
        if (item.id !== row.id) {
