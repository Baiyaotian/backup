    ...
    <div class="container-content">
            ...
            <div class="grid-content bg-purple">
              ...
              <el-dialog title="创建备份计划"
                ...
                <addSource @resflesh-click="resCick"
                           v-model="addFormVisible"></addSource>
              </el-dialog>
              <el-dialog title="编辑备份计划"
                         :visible.sync="editFormVisible">
                <editSource @resflesh-click="resCick"
            ...
            <div class="grid-content bg-purple">
              <el-input :placeholder="placeholder"
                ...
                <el-button slot="append"
                           icon="el-icon-search"
                           @click.native="searchclick"></el-button>
              </el-input>
            </div>
          </el-col>
      ...
      <el-table border="border"
        ...
        <el-table-column prop="backupName"
                         ...
                         min-width="120"
                         sortable="custom"
                         label="备份任务名"></el-table-column>
        <el-table-column prop="ip"
                         show-overflow-tooltip
                         align="center"
                         min-width="120px"
                         sortable="custom"
                         label="客户端IP"></el-table-column>
        <el-table-column prop="bucket"
                         align="center"
                         min-width="82"
                         label="对象储存桶"></el-table-column>
        <el-table-column prop="backupGroup"
                         align="center"
                         min-width="85"
                         label="备份类型">
        </el-table-column>
          ...
          <template slot-scope="scope">
            <div class="btn-size">
              ...
              <el-tooltip class="item"
                          ...
                          content="触发"
                          placement="top-start">
                <el-button @click="tiggerBackup(scope.row)"
                           size="small"
                           type="primary"
                           icon="iconfont icon-trigger"></el-button>
              </el-tooltip>
              <el-tooltip class="item"
                          effect="dark"
                          content="中断"
                          placement="top-start">
                <el-button @click="interruptBackup(scope.row)"
                           size="small"
                           icon="iconfont icon-Interrupts"
                           class="tiggerbtn"></el-button>
              </el-tooltip>
              ...
              <el-tooltip class="item"
                ...
                <el-button size="small"
                           type="warning"
                           icon="el-icon-edit"
                           @click.native="editSoure(scope.row)"></el-button>
              </el-tooltip>
              <el-tooltip class="item"
                          effect="dark"
                          content="删除"
        ...
        <el-table-column type="expand"
          ...
          <template slot-scope="scope">
            ...
            <div class="other-backgroundcol"
              ...
              <el-row>
                <el-col :span="12">备份保留时间: {{scope.row.holdTime}}{{scope.row.holdType === 0 ? '天' : scope.row.holdType === 1 ? '月' : '年'}}</el-col>
              </el-row>
              <el-row>
      ...
      <div class="block">
        <el-pagination :current-page="currentPages"
...
import { BACKUP_STATE, BACKUP_STATE_COLOR, BACKUP_GROUP_TYPE, BACKUP_STATE_ICON } from '@/utils/type'
...
export default {
  ...
  methods: {
    ...
    searchChange (val) {
      this.placeholder = `请输入${val === 'backupName' ? '备份任务名' : '客户端Ip'}`
    },
    searchclick () {
      this.getBackup(this.currentPages, this.select, this.input3, this.sort, this.order)
    },
    tableSortChange ({ column, prop, order }) {
      ...
      this.getBackup(this.currentPages, this.select, this.iuput3, this.sort, this.order)
    },
